...
keySet = {'connect', ...
          ...
          'bmmeH', ...
          'dhtH'};
valueSet1 = {'Arduino Cloud Connection', ...
    'Email', ...
    'Light', ...
    'Lighting', ...
    'Door', ...
    ...
    'BMME Humidity', ...
    'DHT Humidity'};
valueSet2 = {'connect to Arduino Cloud. Sending e-mail notification.', ...
...
% Send notification email (except notification email can't be send)
if ~strcmp(id,'email')
    email(id);
end
